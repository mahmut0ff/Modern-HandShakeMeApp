    ...
    <SafeAreaView className="flex-1 bg-[#F8F7FC]">
      ...
      <ScrollView className="flex-1 px-4 pt-4" contentContainerStyle={{ paddingBottom: 20, paddingTop: 8 }}>
        ...
        <View className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100 mb-4">
          <Text className="text-lg font-bold text-gray-900 mb-4">Возможности</Text>
          
          <View className="space-y-4">
            {[
              { icon: 'search', title: 'Поиск мастеров', desc: 'Найдите проверенных специалистов' },
              { icon: 'shield-checkmark', title: 'Безопасные сделки', desc: 'Защищенные платежи через эскроу' },
              { icon: 'star', title: 'Система рейтингов', desc: 'Честные отзывы от реальных клиентов' },
              { icon: 'chatbubbles', title: 'Встроенный чат', desc: 'Общение с мастерами в приложении' },
            ].map((feature, index) => (
